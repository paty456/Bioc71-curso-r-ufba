...
#eRRO POIS N FOI AUTORIZADO PARA EDICOES

#O que é um pull request? #requisicao para ele puxar, ou seja, notifica ao dono do repositorio sobre a requisicao de clonagem

#O que é um fork? # ao entrar em algum repositorio de outra pessoade alguém, o folk irah  copiar o repositorio completo dessa pessoa para meu git, podendo editar esses arquivos e depois devolver a pessoa com as modificacoes 
